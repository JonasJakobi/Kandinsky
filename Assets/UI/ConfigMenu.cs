...
public class ConfigMenu : MonoBehaviour
{
    ...
    private struct RuleFields{
        ...
        public IntegerField minAmount;
        public Toggle maxAmountRule;
        public IntegerField maxAmount;
    ...
    ShapeRule CreateShapeRuleFromFields(){
        ...
        int minAmount = ruleFields.minAmount.value;
        bool maxAmountRule = ruleFields.maxAmountRule.value;
        int maxAmount = ruleFields.maxAmount.value;
    ...
    IntegerField CreateIntegerField(String title, String classList){
